export const quizData = {
    programming: [
        {
            question: "Quais os nomes das funções que convertem um objeto literal em um Json, e um Json em objeto literal, respectivamente.",
            options: ["JSON.stringfy() e JSON.parse()", "JSON.toJson() e JSON.toObject()", "JSON.convertJson() e JSON.convertObject()", "JSON.parse() e JSON.toObject()"],
            answer: "JSON.stringfy() e JSON.parse()"          
        },
        {
            question: "Segundo a documentação oficial do React.js, o que é o React?",
            options: ["Framework", "Biblioteca", "Gerenciador de interfaces", "Gerenciador de dependências"],
            answer: "Biblioteca"
        },
        {
        ...
        },
        {
            ...
            options: ["Home Tool Markup Language", "Hyperlink Markup Language", "Hyper Textual Markup Language", "Hypertext Markup Language"],
            answer: "Hypertext Markup Language"
        },
        {
            question: "O que é uma função recursiva em programação?",
            options: ["Uma função recursiva é uma função que não permite a passagem de argumentos.",
                "Uma função recursiva é uma função que só pode ser chamada uma vez dentro de um programa.",
                "Uma função recursiva é uma função que chama a si mesma dentro do seu próprio corpo.",
                "Uma função recursiva é uma função que realiza operações matemáticas complexas."],
            answer: "Uma função recursiva é uma função que chama a si mesma dentro do seu próprio corpo."
        },
        {
            question: "O que é uma chave primária em um banco de dados relacional?",
            options: [" A chave primária é um índice secundário que permite acesso rápido aos dados em uma tabela.",
        ...
        },
        {
            ...
            options: ["O primeiro computador foi o ENIAC (Electronic Numerical Integrator and Computer), desenvolvido nos Estados Unidos.",
        ...
        {
            question: "Qual a diferença entre os operadores de comparação de valores '==' e '===' em Javascript?",
            options: ["Ambos os operadores '==' e '===' comparam os valores e os tipos de dados das variáveis.",
        ...
        },
        {
            ...
            options: ["JavaScript Object Notation.", "Java Syntax Object Notation.", "JavaScript Oriented Notation.", "Java Object Naming."],
